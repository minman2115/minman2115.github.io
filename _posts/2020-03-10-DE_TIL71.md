...
source_s3 = "wj-alp-code"
destination_bucket = 'wjtb-stg-deploy'
destination_prefix = 'aip'
destination_s3_location = destination_bucket +'/'+ destination_prefix
task_name = "task 1"

sync_command = f"aws s3 sync s3://{source_s3}/ s3://{destination_s3_location}/ --delete --acl bucket-owner-full-control"
...
# if source_object_list[0:math.floor(len(source_object_list)*0.9)] == destination_object_list[0:math.floor(len(source_object_list)*0.9)] : 

        logfile.write("data integrity check success \n".encode())
        logfile.write("{} to {} complete \n".format(source_s3,destination_s3_location).encode())
