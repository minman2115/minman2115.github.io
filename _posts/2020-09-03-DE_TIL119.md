...
def get_computer_metric():
    ...
    computer_stat['timestamp'] = (datetime.datetime.now() - datetime.timedelta(hours=9)).strftime('%Y-%m-%dT%H:%M:%SZ')
...
def lambda_handler(event,context):
    ...
    for record in event["Records"]:
        ...
        es.index(index="com_metric", doc_type="header_data", id=es_id, body=json_data)
...
![kibana result](https://user-images.githubusercontent.com/41605276/92077713-ee5d0500-edf7-11ea-8528-263c7fbde535.png)
