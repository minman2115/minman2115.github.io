---
layout: post
title: "Airflow를 이용한 EMR spark workload 구현예시"
...
- Airflow를 이용하여 dags를 생성하고, 실행하여 EMR cluster를 구동하고 spark job까지 처리하는 workload를 구현한다. 
...
#### step 5) Airflow UI에 접속하여 스케쥴링 구동
...
- 스케쥴링이 트리거링 되면서 우리가 의도한 workflow가 구동되는 것을 확인할 수 있다.
