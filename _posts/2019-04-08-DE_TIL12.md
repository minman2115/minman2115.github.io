...
스텝 19) 트위터 컨넥트 폴더에서 mvn clean package 입력 및 실행해서 다시 빌드

그 다음에 export CLASSPATH='pwd'/target/kafka-connect-twitter-0.1-jar-with-dependencies.jar 실행
...
스텝 22) 새 터미널 열어 카프카 폴더에서 컨슈머 실행

bin/kafka-console-consumer.sh --bootstrap-server localhost:9092 --topic test --from-beginning

스텝 23) 새 터미널 열어서 카프카 폴더에서 
