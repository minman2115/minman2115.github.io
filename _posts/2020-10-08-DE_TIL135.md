---
layout: post
title: "Airflow에서 Task 병렬실행을 위한 초기 환경설정 셋팅 (작업중)"
...
[ec2-user@ip-10-1-10-239 ~]$ sudo pip3 install -U flask
[ec2-user@ip-10-1-10-239 ~]$ sudo pip3 uninstall werkzeug -y
[ec2-user@ip-10-1-10-239 ~]$ sudo pip3 install werkzeug==0.16.0
[ec2-user@ip-10-1-10-239 ~]$ sudo pip3 install celery
...
https://minman2115.github.io/DE_TIL136/ 를 참고해서 설치한다.
...
sql_alchemy_conn = mysql://airflow:MyNewStrongP@ssw0d!@localhost/airflow
...
```python
# webserver 구동
[ec2-user@ip-10-1-10-33 ~]$ airflow webserver -p 8080
...
[ec2-user@ip-10-1-10-239 ~]$ airflow worker
